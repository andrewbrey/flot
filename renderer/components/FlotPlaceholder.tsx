					...
					<div className="px-4 pt-7 pb-4 grid place-items-center h-full select-none">
						<div className="max-w-sm mx-auto ">
							...
							<p className="pt-2 text-sm text-teal-200">
								Use the options to control the opacity of the flōted content. When Flōt is not the
								active window, only the flōted website will be displayed!
							</p>
							<p className="pt-6 pb-4 text-sm text-teal-500">
								<span className="font-black">Note:</span> some websites can't be loaded with Flōt as
								the website itself must permit being displayed as embedded content. If a page fails
								to load, check if the site specifies an "embed" version of the address.
							</p>
						</div>
					</div>
				</div>
