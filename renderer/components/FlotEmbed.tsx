      ...
      {firstLoad && url ? (
        <React.Fragment>
          <iframe
            ...
            src={url}
            className={cn(
              "w-full h-full absolute inset-0 z-10 bg-transparent select-none"
            )}
            allow="autoplay"
            onLoad={handlOnLoad}
          ></iframe>
          <div
            className={cn("w-full h-full absolute inset-0 z-0 select-none", {
              hidden: !url || childLoading,
            })}
          >
            <div className="px-4 pt-2 pb-4 grid place-items-center h-full">
              <div className="max-w-sm mx-auto ">
                ...
                <p className="pt-2 text-sm text-teal-200">
                  Double check the address you entered to ensure it's a valid
                  url. Some websites can't be displayed because their settings
                  forbid it.
                </p>
              </div>
            </div>
